«A1» Выполнен рефакторинг HTML-кода проекта используя методологию BEM. Почему на в комментарии
модального окна по умолчанию не видно placeholder - текст прячется за пробелами.
